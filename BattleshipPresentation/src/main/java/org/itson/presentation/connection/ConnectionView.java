...
public class ConnectionView extends javax.swing.JFrame {
    ...
    public void update(Object object) {
        ...
        String error = "error";
        if (object instanceof HashMap msg) {
            if (msg != null) {
                String message = msg.get("status").toString();
                if (message.equals(connected)) {
                    if (msg.containsKey("status") && !msg.isEmpty()) {
                        this.lblResult.setForeground(Color.GREEN);
                        this.lblResult.setText(message.toString());
                    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(lblResult, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
