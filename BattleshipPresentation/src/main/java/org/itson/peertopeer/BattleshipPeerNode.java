...
/**
 * BattleshipPeerNode es una clase Singleton que actúa como un nodo para el sistema de comunicación
 * peer-to-peer (P2P). Esta clase maneja tanto las conexiones
 * de servidor como las de cliente y es responsable de enviar y recibir mensajes entre nodos.
 */
public class BattleshipPeerNode implements IServerObserver {
    ...
    /**
     * Método estático para obtener la instancia única de BattleshipPeerNode.
    ...
    public void connect(int port) {
     ...
     /**
     * Conecta este nodo a otro nodo utilizando una dirección y un puerto específicos.
     * 
 ...
 /**
    ...
    public void send(Object object) {
     ...
     /**
     * Establece el observador de negocio para manejar eventos relacionados
